...
def manage_vehicles(request):
    ...
    return render(request, 'car_dealer/manage.html', {'wallet':car_dealer.wallet,'vehicle_list':vehicle_list})
...
def order_list(request):
    ...
    for o in orders:
        if o.is_complete == False:
            order_list.append(o)
    return render(request, 'car_dealer/order_list.html', {'wallet':car_dealer.wallet,'order_list':order_list})
